            ...
            <div class="row justify-content-center wow fadeInUp" data-wow-duration="1s"
                ...
                <div class="col-xl-6 col-sm-10 col-md-8 col-lg-6">
                    <div class="tf__login_area item-bg-color ">
                        <h2 class="title title-h2 mb_10 text-center d-block">Nouveau mot de passe</h2>
                        <form class="sign-form" method="post" action="{{ route('customer.resetPassword') }}">
                            @csrf
                            <div class="mb_25">
                                <input placeholder="token" name="token" type="hidden" value="{{ $reset_token }}">
                            </div>
                            <div class="mb_25">
