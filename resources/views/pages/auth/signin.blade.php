            ...
            <div class="row justify-content-center wow fadeInUp" data-wow-duration="1s"
                ...
                <div class="col-xl-6 col-sm-10 col-md-8 col-lg-6">
                    <div class="tf__login_area item-bg-color ">
                        ...
                        <form class="sign-form" method="post" action="{{ route('customer.signin') }}">
                            @csrf
                            <input type="hidden" name="redirectTo"
                                value="{{ Request::get('to') ? Request::get('to') : 'home' }}">
                            <div class="mb_25">
                        ...
                        <div class="create_account text-center black-color">
                            ...
                            <a href="{{ route('signup') }}{{ Request::get('to') ? '/?to=' . Request::get('to') : '' }}">
                                Créez-en un maintenant !</a>
                            <div>
                                <a href="{{ route('recover-password') }}"> Mot de passe oublié</a>
                            </div>
                        </div>
                    </div>
                </div>
