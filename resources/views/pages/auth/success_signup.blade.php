        ...
        <div class="container">
            <div class="row justify-content-center wow fadeInUp" data-wow-duration="1s"
                ...
                <div class="col-xl-6 col-sm-10 col-md-8 col-lg-6">
                    <div class="tf__login_area item-bg-color   order_valide text-center">
                        <div class="text-center  icon_valide">
                        </div>
                        <h2 class="title title-h2 mb_10 text-center d-block">
                            Félicitations ! <br >
                            Vous êtes maintenant inscrit sur notre site.
                        </h2>
                        <p class="text text-center">
                            Veuillez vous connecter en utilisant vos identifiants pour accéder
                            à votre compte personnel.
                        </p>
                        <a class="buttons buttons-theme buttons-md " href="{{ route('signin') }}">Cliquer ici</a>
                    </div>
                </div>
            </div>
        </div>
