...
<head>
    ...
    <title>{{ env('APP_NAME') }} - Internal Server Error</title> 
...
<body>
    <div class="main-error-page">
        ...
        <p class="error-subtitle">Impossible de traiter cette demande. veuillez soit :</p>
        <ul class="error-list">
            <li>Actualiser la page</li>
            <li>ou contacter le propriétaire du site web</li>
        </ul>
