<template>
  ...
  <dialog-confirmation ref="dialogEditUser" />
</template>
<script lang="ts">
...
export default {
  ...
  created() {
    this.initialValues.email = this.userStore?.data.email
    this.initialValues.firstName = this.userStore?.data.firstName
    this.initialValues.lastName = this.userStore?.data.lastName
    this.initialValues.phone = this.userStore?.data.phone
  },
  methods: {
    ...
    async handleSubmit(values, actions) {
      ...
      const selectedAction = await this.$refs.dialogEditUser.open(sweetOption);
