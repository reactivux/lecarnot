<template>
    <div class="col-xl-4 col-lg-4 col-md-5 col-sm-12 col-12 wow fadeInUp section-cart"
        :class="{ displayCartMobile: openCartMobile }">
        <div class="head">
            Votre panier
            <div class="closeModal  " @click="openCartMobile = false"><span class="icon   icon-close"></span></div>
        </div>
        <div id="sticky_sidebar" class="cart-list top-20 sticky-top cart">
            <div v-if="cartStore?.products?.length" class="cart-content item-bg-color">
                            ...
                            <div v-if="group.used">
                                ...
                                <div class="subProductName d-flex justify-content-between" v-for="subProduct in group?.sub_products.filter(
                                    ...
                                    <div style="width: 100%;">
                                        ...
                                        <span v-if="subProduct.price>0" class="float-end text-color">€
                ...
                <a href="javascript:void(0)" class="buttons buttons-theme buttons-md w-100" @click="checkout">
                    Commander maintenant
                </a>
            </div>

            <div v-else class="cart-content item-bg-color">
                <notfound-component title="" description="Panier vide. Vous pouvez commencer à ajouter des produits."
                    img="" />
            </div>
        </div>
    </div>
    <div class="showCartMobile" @click="showCartMobile">Votre panier</div>
